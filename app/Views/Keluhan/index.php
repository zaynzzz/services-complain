<div class="container-fluid py-3 my-5">
    ...
    <table id='keluhantable' class="table table-striped|sm|bordered|hover|inverse table-inverse table-responsive">
        ...
        <tbody>
            <?php $i = 1;
            $query = db_connect()->query("SELECT idkeluhan,nama_pelanggan,keluhan,penyebab,tindakan,tgl_keluhan,tgl_perbaikan,nama_teknisi FROM keluhan
        JOIN `pelanggan` ON keluhan.idpelanggan=`pelanggan`.idpelanggan 
        JOIN teknisi ON keluhan.idteknisi=teknisi.idteknisi")->getResult();
